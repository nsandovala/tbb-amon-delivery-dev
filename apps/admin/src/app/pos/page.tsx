...
import { createAdminOrder } from "../../lib/firebase/mutations/orders";
import {
  Minus,
  Plus,
  Search,
...
export default function PosPage() {
  ...
  async function handleCreateOrder() {
    ...
    try {
      ...
      clearPos();
      alert(`Pedido creado: #${orderId.slice(0, 6).toUpperCase()}`);
    } catch (error) {
      console.error("Error creando pedido POS:", error);
      alert("No pudimos crear el pedido desde POS.");
    } finally {
          ...
          <aside className="rounded-3xl border border-white/10 bg-[#101010] p-5">
            <div className="mb-5 flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-2 text-sm text-neutral-400">
                  Carrito POS y creación de pedido manual.
                </p>
              </div>
